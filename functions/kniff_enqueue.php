...
if (!function_exists('enqueue_template_part_files')) {
...
if (!function_exists('kniff_enqueue_script')) {
...
if (!function_exists('kniff_enqueue_template')) {
...
if (!function_exists('kniff_enqueue_style')) {
...
if (!function_exists('kniff_enqueue_buffer_start')) {
...
if (!function_exists('kniff_enqueue_buffer_end')) {
